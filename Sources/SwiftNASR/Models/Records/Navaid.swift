...
public struct Navaid: ParentRecord {
    ...
    init(id: String, name: String, type: Self.FacilityType, city: String, stateName: String?, FAARegion: String, country: String?, ownerName: String?, operatorName: String?, commonSystemUsage: Bool, publicUse: Bool, navaidClass: Self.NavaidClass?, hoursOfOperation: String?, highAltitudeARTCCCode: String?, lowAltitudeARTCCCode: String?, position: Location, TACANPosition: Location?, surveyAccuracy: Self.SurveyAccuracy?, magneticVariation: Int?, magneticVariationEpoch: Date?, simultaneousVoice: Bool?, powerOutput: UInt?, automaticVoiceID: Bool?, monitoringCategory: Self.MonitoringCategory?, radioVoiceCall: String?, TACANChannel: Self.TACANChannel?, frequency: UInt?, beaconIdentifier: String?, fanMarkerType: Self.FanMarkerType?, fanMarkerMajorBearing: UInt?, VORServiceVolume: Self.ServiceVolume?, DMEServiceVolume: Self.ServiceVolume?, lowAltitudeInHighStructure: Bool?, ZMarkerAvailable: Bool?, TWEBHours: String?, TWEBPhone: String?, controllingFSSCode: String?, NOTAMAccountabilityCode: String?, LFRLegs: [LFRLeg]?, status: Self.Status, pitchFlag: Bool, catchFlag: Bool, SUAFlag: Bool, restrictionFlag: Bool?, HIWASFlag: Bool?, TWEBRestrictionFlag: Bool?, remarks: [String] = [String](), associatedFixes: Set<String> = Set<String>(), associatedHoldingPatterns: Set<HoldingPatternID> = Set<HoldingPatternID>(), fanMarkers: Set<String> = Set<String>(), checkpoints: [VORCheckpoint] = [VORCheckpoint]()) {
        self.ID = id
        self.name = name
        self.type = type
        self.city = city
