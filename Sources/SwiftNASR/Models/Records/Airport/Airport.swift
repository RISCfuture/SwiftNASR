...
public struct Airport: ParentRecord {
  ...
  init(
    ...
    customsLandingRightsAirport: Bool?,
    jointUseAgreement: Bool?,
    ...
    basedJetGA: UInt?,
    basedHelicopterGA: UInt?,
    basedOperationalGliders: UInt?,
    basedOperationalMilitary: UInt?,
    basedUltralights: UInt?,
    annualCommercialOps: UInt?,
    annualCommuterOps: UInt?,
    annualAirTaxiOps: UInt?,
    ...
    windIndicator: Self.AirportMarker?,
  ...
  public enum Field: String, RemarkField {
    ...
    case annualCommercialOps, annualCommuterOps, annualAirTaxiOps, annualLocalGAOps,
      annualTransientGAOps, annualMilitaryOps, annualPeriodEndDate

    case positionSource, positionSourceDate, elevationSource, elevationSourceDate,
      contractFuelAvailable, transientStorageFacilities, otherServices, windIndicator,
    ...
    static let fieldOrder: [Self?] = [
      ...
      .annualTransientGAOps, .annualMilitaryOps, .annualPeriodEndDate,
      .positionSource, .positionSourceDate, .elevationSource, .elevationSourceDate,
      .contractFuelAvailable, .transientStorageFacilities, .otherServices, .windIndicator,
      .ICAOIdentifier, .minimumOperationalNetwork, nil
    ]
  }
