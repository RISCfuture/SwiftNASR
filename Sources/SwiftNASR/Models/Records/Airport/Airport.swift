...
public struct Airport: ParentRecord {
    ...
    public let fuelsAvailable: [FuelType]
    ...
    public let bottledOxygenAvailable: [OxygenPressure]

    /// The type of bulk oxygen available for purchase.
    public let bulkOxygenAvailable: [OxygenPressure]

    /// The type of transient aircraft storage facilities available.
    public let transientStorageFacilities: [StorageFacility]?

    /// Other services available at this airport.
    public let otherServices: [Service]
    ...
    init(id: String, name: String, LID: String, ICAOIdentifier: String?, facilityType: Self.FacilityType, FAARegion: Self.FAARegion?, FAAFieldOfficeCode: String?, stateCode: String?, county: String, countyStateCode: String, city: String, ownership: Self.Ownership, publicUse: Bool, owner: Self.Person?, manager: Self.Person?, referencePoint: Location, referencePointDeterminationMethod: Self.LocationDeterminationMethod, elevationDeterminationMethod: Self.LocationDeterminationMethod?, magneticVariation: Int?, magneticVariationEpoch: Date?, trafficPatternAltitude: Int?, sectionalChart: String?, distanceCityToAirport: UInt?, directionCityToAirport: Direction?, landArea: Float?, boundaryARTCCID: String, responsibleARTCCID: String, tieInFSSOnStation: Bool?, tieInFSSID: String, alternateFSSID: String?, NOTAMIssuerID: String?, NOTAMDAvailable: Bool?, activationDate: Date?, status: Self.Status, ARFFCapability: Self.ARFFCapability?, agreements: [Self.FederalAgreement], airspaceAnalysisDetermination: Self.AirspaceAnalysisDetermination?, customsEntryAirport: Bool?, customsLandingRightsAirport: Bool?, jointUseAgreement: Bool?, militaryLandingRights: Bool?, inspectionMethod: Self.InspectionMethod?, inspectionAgency: Self.InspectionAgency?, lastPhysicalInspectionDate: Date?, lastInformationRequestCompletedDate: Date?, fuelsAvailable: [Self.FuelType], airframeRepairAvailable: Self.RepairService?, powerplantRepairAvailable: Self.RepairService?, bottledOxygenAvailable: [Self.OxygenPressure], bulkOxygenAvailable: [Self.OxygenPressure], airportLightingSchedule: Self.LightingSchedule?, beaconLightingSchedule: Self.LightingSchedule?, controlTower: Bool, UNICOMFrequency: UInt?, CTAF: UInt?, segmentedCircle: Self.AirportMarker?, beaconColor: Self.LensColor?, landingFee: Bool?, medicalUse: Bool?, basedSingleEngineGA: UInt?, basedMultiEngineGA: UInt?, basedJetGA: UInt?, basedHelicopterGA: UInt?, basedOperationalGliders: UInt?, basedOperationalMilitary: UInt?, basedUltralights: UInt?, annualCommercialOps: UInt?, annualCommuterOps: UInt?, annualAirTaxiOps: UInt?, annualLocalGAOps: UInt?, annualTransientGAOps: UInt?, annualMilitaryOps: UInt?, annualPeriodEndDate: Date?, positionSource: String?, positionSourceDate: Date?, elevationSource: String?, elevationSourceDate: Date?, contractFuelAvailable: Bool?, transientStorageFacilities: [Self.StorageFacility]?, otherServices: [Self.Service], windIndicator: Self.AirportMarker?, minimumOperationalNetwork: Bool) {
        self.id = id
        self.name = name
        self.LID = LID
    ...
    public struct Person: Record {
        ...
        public enum Field: String, RemarkField {
            ...
            static var fieldOrder: [Self?] {
                var order = [Self?](repeating: nil, count: 15)
    ...
    public enum AirspaceAnalysisDetermination: String, RecordEnum {
        ...
        static var synonyms: [String: Self] {[
