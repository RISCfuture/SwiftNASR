...
public struct RunwayEnd: Record {
    ...
    init(ID: String, trueHeading: UInt?, instrumentLandingSystem: Self.InstrumentLandingSystem?, rightTraffic: Bool?, marking: Self.Marking?, markingCondition: Self.MarkingCondition?, threshold: Location?, thresholdCrossingHeight: UInt?, visualGlidepath: Float?, displacedThreshold: Location?, thresholdDisplacement: UInt?, touchdownZoneElevation: Float?, gradient: Float?, TORA: UInt?, TODA: UInt?, ASDA: UInt?, LDA: UInt?, LAHSO: Self.LAHSOPoint?, visualGlideslopeIndicator: Self.VisualGlideslopeIndicator?, RVRSensors: [Self.RVRSensor], hasRVV: Bool?, approachLighting: Self.ApproachLighting?, hasREIL: Bool?, hasCenterlineLighting: Bool?, endTouchdownLighting: Bool?, controllingObject: Self.ControllingObject?, positionSource: String?, positionSourceDate: Date?, elevationSource: String?, elevationSourceDate: Date?, displacedThresholdPositionSource: String?, displacedThresholdPositionSourceDate: Date?, displacedThresholdElevationSource: String?, displacedThresholdElevationSourceDate: Date?, touchdownZoneElevationSource: String?, touchdownZoneElevationSourceDate: Date?) {
        self.ID = ID
