...
public struct FSS: ParentRecord {
    ...
    init(ID: String, airportID: String?, name: String, radioIdentifier: String?, type: FSSType, hoursOfOperation: String, status: Status?, lowAltEnrouteChartNumber: String?, frequencies: [Frequency], commFacilities: [CommFacility], outlets: [Outlet], navaids: [Navaid], airportAdvisoryFrequencies: [Frequency], VOLMETs: [VOLMET], owner: Operator?, ownerName: String?, operator: Operator, operatorName: String?, hasWeatherRadar: Bool?, hasEFAS: Bool, flightWatchAvailability: String?, nearestFSSIDWithTeletype: String?, city: String?, stateName: String?, region: String?, location: Location?, DFEquipment: DirectionFindingEquipment?, phoneNumber: String?, remarks: [String], commRemarks: [String]) {
        self.ID = ID
