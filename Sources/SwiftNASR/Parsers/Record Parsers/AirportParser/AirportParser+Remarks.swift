...
extension FixedWidthAirportParser {
  ...
  func parseRemarkRecord(_ values: [ArraySlice<UInt8>]) throws {
    ...
    if try tryAirportGeneralRemark(remark, &airport, fieldID) {
      remarkParsed = true
    } else if try tryAirportLightingRemark(remark, &airport, fieldID) {
      remarkParsed = true
    } else if try tryAttendanceScheduleRemark(remark, &airport, fieldID) {
      remarkParsed = true
    } else if try tryRunwayOrEndFieldRemark(remark, &airport, fieldID) {
      remarkParsed = true
    } else if try tryAirportFieldRemark(remark, &airport, fieldID) {
      remarkParsed = true
  ...
  private func tryAirportLightingRemark(
    _ remark: String,
    _ airport: inout Airport,
    _ fieldID: String
  ) throws -> Bool {
  ...
  private func tryAttendanceScheduleRemark(
    _ remark: String,
    _ airport: inout Airport,
    _ fieldID: String
  ) throws -> Bool {
  ...
  private func tryAirportFuelRemark(
    _ remark: String,
    _ airport: inout Airport,
    _ combinedFieldID: String
  ) throws -> Bool {
  ...
  private func tryRunwayOrEndFieldRemark(
    _ remark: String,
    _ airport: inout Airport,
    _ combinedFieldID: String
  ) throws -> Bool {
  ...
  private func tryArrestingSystemRemark(
    _ remark: String,
    _ airport: inout Airport,
    _ endID: String,
    _ fieldID: String
  ...
  private func tryRunwayEndFieldRemark(
    _ remark: String,
    _ airport: inout Airport,
    _ endID: String,
    _ fieldID: String
    ...
    let endFound = try updateRunwayEnd(endID, inAirport: &airport) { end in
      if try tryLAHSOFieldRemark(remark, &end, fieldID) {
        endUpdated = true
      } else if try tryControllingObjectFieldRemark(remark, &end, fieldID) {
        endUpdated = true
      } else {
        ...
        switch field {
          case .LAHSO:
            preconditionFailure(
              "NASR field defined in RunwayEnd.Field.fieldOrder but not LAHSO.Field.fieldOrder"
            )
          case .controllingObject:
            preconditionFailure(
              "NASR field defined in RunwayEnd.Field.fieldOrder but not ControllingObject.Field.fieldOrder"
            )
          default:
    ...
    if endFound && !endUpdated { return false }
    if runwayEndFieldForID(fieldID) != nil {
      throw AirportRemarksError.unknownRunwayEnd(endID, airport: airport)
    }
    return false
  }

  private func tryLAHSOFieldRemark(_ remark: String, _ end: inout RunwayEnd, _ fieldID: String)
    throws -> Bool
  {
  ...
  private func tryControllingObjectFieldRemark(
    _ remark: String,
    _ end: inout RunwayEnd,
    _ fieldID: String
  ) throws -> Bool {
  ...
  private func tryRunwayEndGeneralRemark(
    _ remark: String,
    _ airport: inout Airport,
    _ endID: String,
    _ fieldID: String
  ...
  private func tryRunwayFieldRemark(
    _ remark: String,
    _ airport: inout Airport,
    _ runwayID: String,
    _ fieldID: String
  ...
  private func tryAirportFieldRemark(_ remark: String, _ airport: inout Airport, _ fieldID: String)
    throws -> Bool
  {
    ...
    switch field {
      case .owner, .manager:
        preconditionFailure(
          "NASR field defined in Airport.Field.fieldOrder but not Person.Field.fieldOrder"
        )
      default:
  ...
  private func tryAirportPersonRemark(_ remark: String, _ airport: inout Airport, _ fieldID: String)
    throws -> Bool
  {
    ...
    switch airportField {
      ...
      default:
        preconditionFailure(
          "Person field on Airport.Field.fieldOrder does not correspond with same field on Person.Field.fieldOrder"
        )
    }
  }
  ...
  private func runwayEndIndexForID(_ identifier: String, inAirport airport: Airport) -> (
    Int, RunwayEndType
  )? {
  ...
  private func updateRunwayEnd(
    ...
    process: (inout RunwayEnd) throws -> Void
  ) rethrows -> Bool {
  ...
  private func updateRunway(
    _ identifier: String,
    inAirport airport: inout Airport,
    process: (inout Runway) throws -> Void
  ) rethrows -> Bool {
